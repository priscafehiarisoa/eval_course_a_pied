        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select type="text" class="form-select <c:if test="${formError.get('error')!=null}" ><c:out value="is-invalid"></c:out></c:if>" id="select-users" value="" name="idCoureur">
                    ...
                    <div class="invalid-feedback"><%=formError.get("error")%></div>
                </div>
